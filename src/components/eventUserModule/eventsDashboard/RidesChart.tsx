...
export default function RidesChart() {
  ...
  useEffect(() => {
    if (chartRef.current) {
      ...
      gradient.addColorStop(0, "rgba(0, 180, 216, 0.4)"); // Light blue
  ...
  const data = {
    labels: ["10-05-2024", "11-05-2024", "12-05-2024", "13-05-2024", "14-05-2024", "15-05-2024", "16-05-2024"],
    datasets: [
      {
        type: "line",
        label: "Total Rides/Jobs",
        data: [5, 50, 25, 70, 15, 90, 8,],
        borderColor: "#0EBAA8",
        borderWidth: 2, // Adjusts the line thickness
  ...
  return (
    <Card className="card-total-ride custom-card">
         <div className='table-top d-flex justify-content-between gap-3'>
            <div className='left-table  position-relative'>
                <h6 className="text-secondary">Total Events/User</h6>
                <h3 className="text-primary">1254</h3>
            </div>
        ...
        <div className="chart-total" style={{ height: "150px" }}>
