            ...
            <Table responsive className='mb-0'>
                ...
                <tbody>
                    <tr>
                        ...
                        <td className='text-start'>Accra</td>
                        <td>
                            <div className='text-img-box d-flex justify-content-center align-items-center gap-2'>
                    ...
                    <tr>
                        ...
                        <td className='text-start'>Kumasi</td>
                        <td>
                            <div className='text-img-box  justify-content-center d-flex align-items-center gap-2'>
                                <div className='table-img fixed-map'>
                                    <Image src={GhanaImg} alt=''></Image>
                                </div>
                                <div className='table-text text-start'>
                    ...
                    <tr>
                        ...
                        <td className='text-start'>Tamale</td>
                        <td>
                            <div className='text-img-box  justify-content-center d-flex align-items-center gap-2'>
                                <div className='table-img fixed-map'>
                                    <Image src={GhanaImg} alt=''></Image>
                    ...
                    <tr>
                        ...
                        <td className='text-start'>Sekondi - Takoradi</td>
                        <td>
                            <div className='text-img-box   justify-content-center d-flex align-items-center gap-2'>
                                <div className='table-img  fixed-map'>
                                    <Image src={GhanaImg} alt=''></Image>
                    ...
                    <tr>
                        ...
                        <td className='text-start'>Ashaiman</td>
                        <td>
                            <div className='text-img-box  justify-content-center d-flex align-items-center gap-2'>
                                <div className='table-img fixed-map'>
                                    <Image src={GhanaImg} alt=''></Image>
...
export default RideShareCitiesTable