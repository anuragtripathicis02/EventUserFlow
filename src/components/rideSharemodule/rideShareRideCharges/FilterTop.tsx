...
import RideShareRideChargesModal from './RideShareRideChargesModal';
...
const FilterTop = () => {
  ...
  return (
    <div className='filter-top-sec'>
        <div className='inner-filter-top d-flex align-items-center flex-wrap gap-3 justify-content-between'>
            <div className='left-box d-flex align-items-center gap-md-3 gap-1 flex-wrap'>
            ...
            <div className='right-box'>
                <Link href="" className='btn btn-secondary d-flex align-items-center gap-1'  onClick={handleShow}>
        ...
        <RideShareRideChargesModal  show={show} handleClose={handleClose}/>
    </div>
  )
}
