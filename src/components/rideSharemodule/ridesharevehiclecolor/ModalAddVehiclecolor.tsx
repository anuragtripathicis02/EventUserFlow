...
const ModalAddVehiclecolor = ({ show, handleClose }: { show: boolean; handleClose: () => void }) => {
  return (
            ...
            <div className='row'>
                <div className='col-md-12 mb-4'>
                    <div className="form-group">
                        <Form.Label htmlFor="text1">Color name</Form.Label>
                ...
                <div className='col-md-12 mb-4'>
                    <div className="form-group">
                        <Form.Label htmlFor="text3">Company Name</Form.Label>
                ...
                <div className='col-md-12 mb-4'>
                    <div className="form-group">
                        <Form.Label htmlFor="text3">Vehicle Model</Form.Label>
                        <Form.Select aria-label="Default select example" id='text3'>
...
export default ModalAddVehiclecolor
