...
import ModalAddVehicleCompany from './ModalAddVehicleCompany';
    ...
    <div className='filter-top-sec'>
        <div className='inner-filter-top d-flex align-items-center flex-wrap gap-3 justify-content-between'>
            ...
            <div className='right-box '>
                <Link href="" onClick={handleShow} className='btn btn-secondary d-flex align-items-center gap-1'>
        ...
        <ModalAddVehicleCompany show={show} handleClose={handleClose}/>
    </div>
  )
}
