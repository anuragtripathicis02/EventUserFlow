...
const ModalAddVehicleCompany = ({ show, handleClose }: { show: boolean; handleClose: () => void }) => {
  return (
            ...
            <div className='row'>
                <div className='col-md-12 mb-4'>
                    <div className="form-group">
                        <Form.Label htmlFor="text1">Company Name</Form.Label>
...
export default ModalAddVehicleCompany
