...
const ModalAddFeature = ({ show, handleClose }: { show: boolean; handleClose: () => void }) => {
  return (
            ...
            <div className='row'>
                <div className='col-md-12 mb-4'>
                    <div className="form-group">
                        <Form.Label htmlFor="text1">What’s the Feature</Form.Label>
                ...
                <div className='col-md-12 mb-4'>
                    <div className="form-group">
                        <Form.Label htmlFor="text3">Vehicle Type</Form.Label>
                        <Form.Select aria-label="Default select example" id='text3'>
                            <option>Select Conpaney</option>
                            <option value="1">Conpaney </option>
                        </Form.Select>
                    </div>
                </div>
