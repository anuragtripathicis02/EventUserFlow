...
const ModalAddVehicleType = ({ show, handleClose }: { show: boolean; handleClose: () => void }) => {
    return (
                    ...
                    <div className='row'>
                        <div className='col-md-12 mb-4'>
                            <div className="form-group">
                                <Form.Label htmlFor="text1">Category Title</Form.Label>
                                <Form.Control type="text" id="text1" aria-describedby="" placeholder='Write here' />
                            </div>
                        </div>
                        <div className='col-md-12 mb-4'>
                            <div className="form-group">
                                <Form.Label htmlFor="text1">Guest Capacity</Form.Label>
                                <Form.Control type="text" id="text1" aria-describedby="" placeholder='5' />
                            </div>
                        </div>
                        <div className='col-md-12 mb-4'>
                            <div className="form-group">
...
export default ModalAddVehicleType
